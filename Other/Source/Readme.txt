...
user in an INI file next to AndreaMosaicPortable.exe called AndreaMosaicPortable.ini.
...
copy AppNamePortable.ini from this directory to AndreaMosaicPortable.ini next to
AndreaMosaicPortable.exe. The options in the INI file are as follows:
